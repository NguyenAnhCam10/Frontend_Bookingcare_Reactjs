...
class ManageDoctor extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            listPayment: [], selectedPayment: '',

            listProvince: [], selectedProvince: '',
            nameClinic: '',
            addressClinic: '',
            note: '',
            clinicId: '',
    ...
    handleSaveContentMarkdown = () => {
        ...
        this.props.saveDetailDoctor({
            ...
            clinicId: this.state.selectedClinic?.value || null,
            specialtyId: this.state.selectedSpecialty?.value || null
    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown && res.data.Markdown.id !== null) {
            let markdown = res.data.Markdown;
            let addressClinic = '', nameClinic = '', note = '', provinceId = '', specialtyId, clinicId = '',
                paymentId = '', priceId = '', selectedPayment = '', selectedPrice = '',
            ...
            <div className='manage-doctor-container'>
                ...
                <div className='more-infor'>
                    ...
                    <div className='content-right'>
                        <label><FormattedMessage id="admin.manage-doctor.creat-infor-doctor" /></label>
